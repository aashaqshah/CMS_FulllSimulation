...
# with command line options: step2 --filein file:HIG-RunIIFall17DRPremix-01966_step1.root --fileout file:HIG-RunIIFall17DRPremix-01966.root --mc --eventcontent AODSIM --runUnscheduled --datatier AODSIM --conditions 94X_mc2017_realistic_v11 --step RAW2DIGI,RECO,RECOSIM,EI --nThreads 8 --era Run2_2017 --python_filename HIG-RunIIFall17DRPremix-01966_2_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 1751
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:HIG-RunIIFall17DRPremix-01966_step1'+str(options.inputFiles[0])+'.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    #annotation = cms.untracked.string('step2 nevts:1751'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIIFall17DRPremix-01966'+str(options.inputFiles[0])+'.root'),
