...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:HIG-RunIIFall17DRPremix-01966'+str(options.inputFiles[0])+'.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HIG-RunIIFall17MiniAODv2-01265'+str(options.inputFiles[0])+'.root'),
